document.addEventListener('DOMContentLoaded', function(){
    ...
    $(function(){                                   //scroll
        ...
        $('.container-hamburg').click (function(){          
          if ($('.head-modal-menu').css('display') === ('none')) {
            $('.head-modal-menu').show(300);
            $('.container-hamburg').css({ "background-color": "transparent", "margin": "0 auto" });
            $('.btn-modal').css ({"background-color": "#1B1A28", "padding": "3% 0"})
          }
          else {
             $('.head-modal-menu').hide(300)
             $('.btn-modal').css ({"background-color": "transparent", "padding": "0"})
              $('.container-hamburg').css({ "background-color": "#9575FF", "margin": " 20px ", "margin-left": "auto" })
          }  
        });
    ...
    wow.init();
      ...
      const dubleSl = new Swiper('.lost-end', {
        slidesPerView: 1,
        spaceBetween: 10,
        centeredSlides: true,
        loop: true,
      ...
      const transSl = new Swiper('.slider-trans', {
        slidesPerView: 1,        
        spaceBetween: 10,
        lazyLoading: true,
        centeredSlides: true,
       ...
       const swiper1 = new Swiper('#respon', {
        slidesPerView: 1,
        spaceBetween: 10,
        centeredSlides: true,
        loop: true,
...
const imgWar = new Swiper('.slider-recomm', {
        slidesPerView: 1,
        spaceBetween: 10,
        centeredSlides: true,
        loop: true,
